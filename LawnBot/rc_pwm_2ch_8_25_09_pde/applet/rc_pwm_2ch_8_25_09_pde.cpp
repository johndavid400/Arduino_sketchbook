...
int pwm_floor = 254;  // adjusts speed of the PWM signal when it goes below the reverese threshold (deadband_low). f(x) = pwm_floor (255) - adj_value1 (let's say it is min 0) = PWM write value (255)
