...
int accel_reading;
int accel_raw;
int accel_offset = 513;    // CHANGE ME TO BE THE SAME AS "accel_reading"
float accel_angle;
float accel_scale = 0.01;

// gyroscope values
int gyro_offset = 392;    // CHANGE ME TO BE THE SAME AS "gyro_reading"
int gyro_raw;
int gyro_reading;
float gyro_rate;
...
void serial_print_stuff(){
  ...
  // After Testing, remove the first set of "//" below:
  //                                      /*
