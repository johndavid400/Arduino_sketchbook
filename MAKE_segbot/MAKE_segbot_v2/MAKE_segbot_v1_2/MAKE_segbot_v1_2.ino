...
void sample_accel(){
  ...
  accel_raw = map(accel_raw, 220, -250, 90, -90);
...
void update_motor_speed(){
  ...
  mySerial.print(m1_speed, DEC);
  mySerial.print(m2_speed, DEC);
}
